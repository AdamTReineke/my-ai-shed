...
show_polyiso = true;            // 2" polyiso rigid foam insulation
show_purlins = true;            // 2x4 purlins for metal roofing
show_eaves = true;              // Outriggers, fascia, fly rafters, barge boards
