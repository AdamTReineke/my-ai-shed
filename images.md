...
![Foundation](renders/01-foundation.png)

**Floor Framing — Posts, beams, joists, rim joists, blocking, and hurricane ties**
![Floor Framing](renders/02-floor-framing.png)

**Floor Deck — Floor framing with 3/4" AdvanTech decking**
![Floor Deck](renders/03-floor-deck.png)

**Walls — Full floor system with wall framing**
![Walls](renders/04-walls.png)

**Full Framing — Floor, walls, trusses, and ladder framing**
![Full Framing](renders/05-full-framing.png)

**Wall Cladding — OSB sheathing, furring strips, and HardiePlank siding**
![Wall Cladding](renders/06-cladding.png)

**Roof Framing — Complete floor and wall system with queen-post trusses**
![Roof Framing](renders/07-trusses.png)

**Complete — Finished shed with all structural and cladding layers**
![Complete](renders/08-complete.png)

## Isolation Views

**Concrete piers only**
![Pier](renders/iso-pier.png)

**Piers, post bases, and post stubs (close-up)**
![Post Base](renders/iso-post-base.png)

**Piers and post bases — foundation system**
![Foundation](renders/iso-foundation.png)

**Posts on their piers and bases**
![Post](renders/iso-post.png)

**Built-up beams viewed from the east side**
![Beam](renders/iso-beam.png)
...
**Mid-span blocking viewed from below**
![Blocking](renders/iso-blocking.png)

**Hurricane tie detail (close-up, east end)**
![Hurricane Tie](renders/iso-hurricane-tie.png)

**Complete floor framing system**
![Floor Framing](renders/iso-floor-framing.png)

**Wall stud framing on the floor deck**
![Wall Framing](renders/iso-wall-framing.png)

**Wall framing with OSB sheathing**
![OSB](renders/iso-osb.png)

**OSB sheathing with vertical furring strips (rainscreen gap)**
![Furring](renders/iso-furring.png)

**Furring with HardiePlank lap siding**
![Siding](renders/iso-siding.png)

**Complete wall cladding — OSB, furring, and siding**
![Cladding](renders/iso-cladding.png)

**Queen-post trusses on the walls**
![Truss](renders/iso-truss.png)

**Trusses with gable-end ladder framing**
![Ladder Framing](renders/iso-ladder-framing.png)
